...
public class TransferenciaExtCtaVista extends CoopeuchAutomatedWebTest{
    ...
    public static Object[] data() {
        return SetDatos.getInstance().getData(TransferenciaExtCtaVista.class);
    }

    @Test
    public void testTransferenciaExtCtaVista() throws Exception {
        ...
        TransferenciaExtCtaVista();
    }

    public void TransferenciaExtCtaVista() throws Exception {
        ...
        screenshot.take (this, driver, "TrasfExtCtaVista");
        ...
        driver.manage().timeouts().implicitlyWait(1, TimeUnit.MINUTES);
        driver.findElement(By.xpath("//div[@id='page-wrapper']/div/div/div[2]/div[2]/div/div/div[2]/table/tbody/tr[2]/td/table/tbody/tr/td/p/i")).click();
        driver.manage().timeouts().implicitlyWait(8000, TimeUnit.SECONDS);
        screenshot.take (this, driver, "TrasfExtCtaVista");
        driver.findElement(By.xpath("//div[@id='page-wrapper']/div/div/div[2]/div[2]/div/div[2]/div/div[2]/button[2]")).click();
        Thread.sleep(3000);
        //Selección de Destinatario
        driver.findElement(By.cssSelector("tr.ng-scope.stUnselected > td > p.ng-binding")).click();
