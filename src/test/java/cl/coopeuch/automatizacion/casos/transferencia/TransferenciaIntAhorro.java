...
public class TransferenciaIntAhorro extends CoopeuchAutomatedWebTest {
  ...
  public String c3;
    ...
    public static Object[] data() {
        return SetDatos.getInstance().getData(TransferenciaIntAhorro.class);
    }

  @Test
  public void testTransferenciaIntAhorro() throws Exception {
    ChromeOptions options = new ChromeOptions();
    options.addArguments("--start-maximized");
    driver = new ChromeDriver(options);  //Bug de Chrome - es necesario maximizar por opciones de Chrome.
    driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
    TransferenciaIntAhorro();
  }

  public void TransferenciaIntAhorro() throws Exception {
    ...
    screenshot.take (this, driver, "TrasfIntAhorro");
    driver.findElement(By.xpath("(//button[@type='button'])[2]")).click();
    driver.manage().timeouts().implicitlyWait(1, TimeUnit.MINUTES);
    Thread.sleep(3000);
    screenshot.take (this, driver, "TrasfIntAhorro");
    //driver.findElement(By.xpath("(//a[@id='sidebarMenuItem']/div/div)[3]")).click();
    driver.findElement(By.xpath(" //a[@id='sidebarMenuItem']/div[text()[contains(.,'Transferencias')]]")).click();
    driver.manage().timeouts().implicitlyWait(1, TimeUnit.MINUTES);
    driver.findElement(By.xpath("//div[@id='page-wrapper']/div/div/div[2]/div[2]/div/div/div[2]/table/tbody/tr[2]/td/table[2]/tbody/tr/td/p/i")).click();
    screenshot.take (this, driver, "TrasfIntAhorro");
    driver.findElement(By.xpath("//div[@id='page-wrapper']/div/div/div[2]/div[2]/div/div[2]/div/div[2]/button")).click();
    driver.manage().timeouts().implicitlyWait(8000, TimeUnit.SECONDS);
    driver.findElement(By.xpath("//div[@id='page-wrapper']/div/div/div[2]/div[2]/div/div[2]/div[2]/div/table/tbody/tr[2]/td/p/i")).click();
